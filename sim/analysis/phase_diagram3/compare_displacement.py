...
def main():
    ...
    for interval in action_intervals:
        ...
        for max_length in max_lengths:
            ...
            for name, phases in all_strategies.items():
                """ strategy A or B """
                displacement = phases['data']['1'][str(round(interval, 2))][str(round(max_length, 2))]['displacement']
    ...
    with open('../data/optimals/with_energy/withEnergy_phaseDiagram_displacement.json', mode='wt', encoding='utf-8') as f:
