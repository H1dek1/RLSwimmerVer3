...
def drawDeformation(ax, df, draw_arms=True):
    ...
    if draw_arms:
        ...
        point1 = np.array([-1.50, 0.90])
        point2 = np.array([-1.33, 0.85])
        start = np.array([-0.50, 0.85])
        end = np.array([-0.76, 0.54])
        ax.text(point0[0]+0.05, point0[1]-0.05, 'A', fontsize=25, ha='right', va='top')
        ax.text(point0[0]-0.05, -point0[1]+0.05, 'A', fontsize=25, ha='right', va='bottom')
        ax.text(point1[0]-0.10, point1[1]-0.05, 'G', fontsize=25, ha='right', va='top')
        ax.text(point1[0]-0.10, -point1[1]+0.05, 'E', fontsize=25, ha='right', va='bottom')
        ...
        ax.text(start[0]-0.35, start[1]+0.05, 'D', fontsize=25, ha='left', va='bottom')
        ax.text(start[0]-0.35, -start[1]+0.05, 'D', fontsize=25, ha='left', va='top')
        ax.annotate('',
                xy=(point1[0], point1[1]),
                xytext=(point0[0], point0[1]),
                arrowprops=dict(
                    arrowstyle='-|>',
        ...
        ax.annotate('',
                xy=(start[0]-0.1, start[1]-0.05),
                xytext=(point1[0], point1[1]),
                arrowprops=dict(
                    arrowstyle='-|>',
                    connectionstyle='arc3',
                    fc='blue',
        ...
        ax.annotate('',
                xy=(point1[0], -point1[1]+0.1),
                xytext=(point0[0], -point0[1]+0.05),
                arrowprops=dict(
                    arrowstyle='-|>',
                    connectionstyle='arc3',
                    fc='red',
        ...
        ax.annotate('',
                xy=(start[0]-0.2, -start[1]+0.1),
                xytext=(point1[0], -point1[1]+0.1),
                arrowprops=dict(
                    arrowstyle='-|>',
                    connectionstyle='arc3',
                    fc='blue',
